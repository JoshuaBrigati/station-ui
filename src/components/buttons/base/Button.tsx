...
const Button = forwardRef(
  (
    ...
    const { variant, label, loading, icon, block, className, children, type, small, dashboardSmall, ...attrs } = props;
    const buttonClassName = cx(styles.button, variant, className, { block, loading, small, dashboardSmall });
