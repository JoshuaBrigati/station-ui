...
export const TokenImage = ({ tokenImg, tokenName, className, small, medium }: TokenImageProps) => {
  ...
  return (
    <div className={cx(styles.image__wrapper, { [styles.small]: small, [styles.medium]: medium })}>
      {isLoading && (
...
export const ChainImage = ({ chainImg, chainName, className, small, xSmall }: ChainImageProps) => {
  ...
  return (
    <div className={cx(styles.image__wrapper, { [styles.small]: small, [styles.x__small]: xSmall })}>
      {isLoading && (
