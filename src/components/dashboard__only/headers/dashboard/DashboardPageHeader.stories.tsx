...
export const MobileExample: StoryObj<DashboardPageHeaderProps> = {
  render: () =>
    <DashboardPageHeader
      pageIcon={<DashboardIcon fill="var(--token-dark-900)" />}
      title="Portfolio"
      subtitle="Overview of your wallet"
      mobileHamburger={<button>Hello</button>}
    />,
};
...
export const PortfolioWithPillTitle: StoryObj<DashboardPageHeaderProps> = {
  render: () =>
    <DashboardPageHeader
      pageIcon={<DashboardIcon fill="var(--token-dark-900)" />}
      title="Portfolio"
      titlePillLabel="Testnet"
      subtitle="Overview of your wallet"
      secondaryNode={
        <Input
          actionIcon={{
