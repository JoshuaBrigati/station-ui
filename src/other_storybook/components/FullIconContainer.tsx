...
const FullIconContainer = () => {
  ...
  const icons = [
    ...
    {
      name: "LoadingV2",
      icon: <LoadingV2Icon width={size} height={size} />,
      iconCopy: `<LoadingIcon />`
    },
    {
      name: "Lock",
    ...
    {
      name: "MenuDots",
      icon: <MenuDotsIcon fill={`var(${selectedColor})`} width={size} height={size} />,
      iconCopy: `<MenuDotsIcon fill={"var(${selectedColor})"} />`
    },
    {
      name: "Multisig",
    ...
    {
      name: "TrendArrowDown",
      icon: <TrendArrowDown fill={"var(--token-error-500)"} width={size} height={size} />,
      iconCopy: `<TrendArrowDown fill={"var(--token-error-500)"} />`
    },
    {
      name: "TrendArrowUp",
      icon: <TrendArrowUp fill={"var(--token-success-500)"} width={size} height={size} />,
      iconCopy: `<TrendArrowUp fill={"var(--token-success-500)"} />`
    },
    {
      name: "Twitter",
